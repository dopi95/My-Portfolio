    ...
    <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 p-6 rounded-lg">
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="relative p-6 rounded-lg border-l-4 border-l-blue-500 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
            <div className="space-y-8">
              ...
              <div className="relative">
                <div className="border-l-2 border-blue-200 dark:border-blue-800 pl-6 py-2">
                  ...
                  <p className="italic mb-3">Currently 4th Year Student</p>
              ...
              <div className="relative">
                <div className="border-l-2 border-blue-200 dark:border-blue-800 pl-6 py-2">
                  ...
                  <p className="italic mb-3">Currently Enrolled - In Progress</p>
                  <p className="text-gray-700 dark:text-gray-300">
            ...
            <div className="space-y-8">
              ...
              <div className="relative">
                <div className="border-l-2 border-blue-200 dark:border-blue-800 pl-6 py-2">
                  ...
                  <h4 className="text-lg font-medium text-blue-600 dark:text-blue-400">Freelance Project</h4>
